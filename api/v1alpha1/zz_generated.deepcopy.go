...
func (in *ProductReleaseList) DeepCopyInto(out *ProductReleaseList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ProductRelease, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ProductReleaseStatus) DeepCopyInto(out *ProductReleaseStatus) {
	*out = *in
	in.AtlasStatus.DeepCopyInto(&out.AtlasStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProductReleaseStatus.
func (in *ProductReleaseStatus) DeepCopy() *ProductReleaseStatus {
	if in == nil {
		return nil
	}
	out := new(ProductReleaseStatus)
	in.DeepCopyInto(out)
	return out
}
